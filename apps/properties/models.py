...
class Property(TimeStampedUUIDModel):
    ...
    country = CountryField(verbose_name=_("Country"), default="ZA", blank_label="(select country)",)
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Johannesburg",)
    postal_code = models.CharField(verbose_name=_("Postal Code"), max_length=180, default="2194")
    street_address = models.CharField(verbose_name=_("Street Address"), max_length= 150, default="Balvicar Road")
    ...
    bathrooms = models.DecimalField(verbose_name=_("Bathrooms"), default=1.0, max_digits=4, decimal_places=2)
    ...
    covert_photo = models.ImageField(verbose_name=_("Main Photo"), default="sample_images/house_sample.jpg", null=True, blank=True)
